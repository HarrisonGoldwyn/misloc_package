...
class LoadedFit(fit.FitModelToData, fit.PlottableDipoles):
...
def fig5(
    ...
    """ Builds figure 5 in polarization rotation paper.
    ...
    if not show_ax_labels:
        ...
        paper_axs[1].set_title('Gaussian Localization')
        paper_axs[2].set_title('Image Model')
